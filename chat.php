...
$fp = fopen('msg.list', 'a+');
$mytext = "<font color='white'>[".$username."]</font><font color='lightgreen'> - ".$msg."</font><br>\n";
...
<div class="list" id="list"><? echo readfile("msg.list"); ?></div>
<form method="POST" name="send" id="chat">
